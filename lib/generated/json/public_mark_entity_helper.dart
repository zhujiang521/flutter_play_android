...
publicMarkEntityFromJson(PublicMarkEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = new List<PublicMarkData>();
		(json['data'] as List).forEach((v) {
			data.data.add(new PublicMarkData().fromJson(v));
		});
	}
...
Map<String, dynamic> publicMarkEntityToJson(PublicMarkEntity entity) {
...
publicMarkDataFromJson(PublicMarkData data, Map<String, dynamic> json) {
...
Map<String, dynamic> publicMarkDataToJson(PublicMarkData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
